...
const UserProfileAvatarEdit = ({close}) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 bg-neutral-900/50 p-4 flex items-center justify-center">
      <div className="bg-white max-w-sm w-full rounded p-4 flex flex-col items-center justify-center">
        ...
        <form onSubmit={handleSubmit}>
          <label htmlFor="uploadProfile">
            <div className="border border-amber-200 hover:bg-amber-400 rounded-full cursor-pointer px-4 py-1 my-3 text-sm">
