  ...
  return (
    <div className="">
      <div className="bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center">
        ...
        <button onClick={()=>setOpenAddress(true)} className="border border-amber-400 text-amber-400 px-3 py-1 hover:bg-amber-400 hover:text-black rounded-full">
          Add Address
        </button>
      </div>
      <div className="bg-blue-50 p-2 grid gap-4">
        ...
        <div
          ...
          className="h-16 bg-blue-50 border-2 border-slate-200 border-dashed flex justify-center items-center cursor-pointer"
        >
          Add address
        </div>
      </div>
